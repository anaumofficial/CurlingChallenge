...
namespace CurlingChallenge.Tests
{
    ...
    {
        [TestCase(6, 2)]
        public void ShouldReturnExpectedCoordinates(int count, int radius)
        {
            ...
            var strategy = new CarolDiscPlacementStrategy();
            var curling = new CurlingService(strategy, coordinatesGenerator);
